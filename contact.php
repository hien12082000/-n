				...
				<div class="row">
					<div class="col-md-5 col-md-push-1 animate-box">
						...
						<div class="fh5co-contact-info">
							...
							<ul>
								<li class="address">Trường đại học kinh doanh và công nghệ Hà Nội</li>
								<li class="phone"><a href="tel://1234567920">0353849417</a></li>
								<li class="email"><a href="mailto:hien0353849417@gmail.com">hien0353849417@gmail.com</a></li>
							</ul>
						</div>

					</div>
					<div class="col-md-6 animate-box">
						<h3>Phản hồi ý kiến</h3>
						<?php
						if (isset($_POST['uploadPhanhoi'])) {
							$userorder = $_POST['userorder'];
							$email = $_POST['email'];
							$noidung = $_POST['noidung'];
							$dateline = date('Y-m-d H:i:s');
							$insert = mysql_query("INSERT INTO phanhoi(userorder,email,noidung,dateline)VALUES('$userorder','$email','$noidung','$dateline')") or die(mysql_errno());
							if (isset($insert)) {
								echo "Phản hồi thành công!";
							} else {
								echo "Phản hồi thất bại!";
							}
						}
						?>
						<form action="" method="post">
							<div class="row form-group">
								<div class="col-md-6">
									...
									<input type="text" id="fname" name="userorder" class="form-control" placeholder="Họ và tên">
								</div>
								<div class="col-md-6">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<textarea id="message" name="noidung" cols="30" rows="10" class="form-control" placeholder="Lời nhắn"></textarea>
								</div>
							</div>
							<div class="form-group">
								<input type="submit" name="uploadPhanhoi" value="Phản hồi" class="btn btn-primary">
							</div>
