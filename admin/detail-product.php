								...
								<div class="card-body">
									...
									<table class="table">
											...
											<thead>
												...
												<tr>
													<th>Hình ảnh : <img src="../images/<?php echo $row['avata'] ?>" alt="" width="150px"></th>
												</tr>
												<tr>
													<th>Tên sản phẩm : <?php echo $row['titleproduct'] ?></th>
												</tr>
												<tr>
													<th>Giá tiền : <?php echo $row['priceproduct'] ?></th>
												</tr>
												<tr>
													<th>Tình trạng : <?php echo $row['tinhtrang'] ?></th>
												</tr>
												<tr>
													<th>Thương hiệu : <?php echo $row['thuonghieu'] ?></th>
												</tr>
												<tr>
													<th>Thời gian : <?php echo $row['dateline'] ?></th>
												</tr>
												<tr>
													<th>Mô tả: <?php echo $row['moto'] ?></th>
												</tr>
												<tr>
													<th>Chức năng : <a href="edit-product.php?id=<?php echo $row['id'] ?>">Sửa</a> - <a href="delete-product.php?id=<?php echo $row['id'] ?>">Xóa</a></th>
												</tr>
											</thead>
											<?php 
												}
