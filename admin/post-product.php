					...
					<div class="card">
						<div class="card-header">
							<?php
									...
									$dateline = date('Y-m-d H:i:s');
										$insert = mysql_query("INSERT INTO postproduct(titleproduct,priceproduct,thuonghieu,tinhtrang,avata,moto,dateline)VALUES('$titleproduct','$priceproduct','$thuonghieu','$tinhtrang','$avata','$moto','$dateline')")or die(mysql_errno());
											if (isset($insert)) {
						...
						<div class="card-block">
							<form action="" method="post" enctype="multipart/form-data">
								<div class="card-body">
									<h5 class="mt-2">Tên sản phẩm</h5>
									<fieldset class="form-group">
										<input type="text" value="" name="titleproduct" class="form-control"
											placeholder="">
									</fieldset>
									<h5 class="mt-2">Giá sản phẩm</h5>
									<fieldset class="form-group">
										<input type="text" value="" name="priceproduct" class="form-control"
											placeholder="">
									</fieldset>
									<h5 class="mt-2">Thương hiệu sản phẩm</h5>
									<fieldset class="form-group">
										<input type="text" value="" name="thuonghieu" class="form-control"
											placeholder="">
									</fieldset>
									<h5 class="mt-2">Tình trạng sản phẩm</h5>
									<fieldset class="form-group">
										<input type="text" value="" name="tinhtrang" class="form-control"
											placeholder="">
									</fieldset>
									...
									<input type="submit" name="upload" value="Thêm sản phẩm">
								</div>
							</form>
						</div>
					</div>
