...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Danh sách đăng ký nhận thông báo</h1>
			</div>
		</div>
		<!--/.row-->
							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<?php					
                                                    $query = mysql_query("SELECT * FROM thongbao  ORDER BY ID DESC");
											...
											<tr>
												...
												<td><a href="delete-thongbao.php?id=<?php echo $row['id'] ?>">Xóa</a>
												</td>
											</tr>
											<?php 
															}
