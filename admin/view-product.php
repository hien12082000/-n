										...
										<table class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td><a href="detail-product.php?id=<?php echo $row['id'] ?>">Xem</a> - <a href="edit-product.php?id=<?php echo $row['id'] ?>">Sửa</a> - <a href="delete-product.php?id=<?php echo $row['id'] ?>">Xóa</a></td>
												</tr>
												<?php 
															}
												?>
